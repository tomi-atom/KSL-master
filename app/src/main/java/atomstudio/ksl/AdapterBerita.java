...
import atomstudio.ksl.response.BeritaItem;
...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tvTglTerbit.setText(berita.get(position).getUpdated());

        // Dapatkan url gambar
        final String urlGambarBerita = "https://ksl-ur.or.id/assets/posts/" + berita.get(position).getPicture();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                varIntent.putExtra("TGL_BERITA", berita.get(position).getUpdated());
                varIntent.putExtra("PNS_BERITA", berita.get(position).getIdAuthor());
                varIntent.putExtra("FTO_BERITA", urlGambarBerita);
                varIntent.putExtra("ISI_BERITA", berita.get(position).getContent());
