...
import atomstudio.ksl.adapter.PostAdapter;
import atomstudio.ksl.item.ItemPost;
import atomstudio.ksl.network.ApiServices;
import atomstudio.ksl.network.InitRetrofit;
...
public class MainActivity extends AppCompatActivity
    ...
    ArrayList<ItemPost> itemPost;
    private ItemPost objItemPost;
    String[] arrayIdPost, arrayIdAuthor, arrayImage, arrayTitle;
    ArrayList<String> listIdPost, listIdAuthor, listImage, listTitle;
