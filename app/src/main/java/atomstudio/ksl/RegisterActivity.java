...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText mUsername, mPasswordView,mCPassword, mNim,mName, mJurusan, mFakultas, mHp;
    private View mProgressView;
    private View mLoginFormView;

    private static final String TAG = "RegisterActivity"; //untuk melihat log
    public static String urlRegister = "http://172.16.102.33/ksl/register.php";
    ...
    private void attemptRegister() {
        ...
        String jurusan = mJurusan.getText().toString();
        String fakultas = mFakultas.getText().toString();
        ...
        if (username.equals("")||nim.equals("")||jurusan.equals("")||fakultas.equals("")||hp.equals("")){
            ...
            addData(username,password,nim,name,jurusan,fakultas,email,hp); //memanggil fungsi tambahData()
    ...
    public void addData(String username, String password,String nim, String name, String jurusan, String fakultas, String email, String hp){
